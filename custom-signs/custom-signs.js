...
export function buildBirthdaySign(age) {
  const _mature = "mature"
  const _young = "young"
  return `Happy Birthday! What a ${age >= 50 ? _mature : _young } fellow you are.`
}
...
console.log(costOf('Happy Birthday!', 'dollars'));

//'Your sign costs 50.00 dollars.'